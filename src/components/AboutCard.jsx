...
const AboutCard = ({ about, index }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="relative flex overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-2x1 shdow-gray-100 dark:shadow-white/10"
