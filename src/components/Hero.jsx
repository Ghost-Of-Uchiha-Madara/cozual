...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="flex flex-col justify-center items-center h-screen min-h-screen px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 text-center w-full overflow-hidden bg-black text-white relative"
    >
      {/* Floating Assets */}
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: -10 }} // slightly lifted up
        transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
        viewport={{ once: true }}
        className="absolute top-[10%] left-1/2 transform -translate-x-1/2 z-10 max-w-4xl w-full text-center" // adjusted position higher to match site
      >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="absolute top-[60%] left-1/2 -translate-x-1/2 z-10 w-[80vw] max-w-[28rem] h-[40vh] max-h-[20rem] md:w-[70vw] md:h-[30vh] lg:w-[50vw] lg:h-[25vh] mx-auto" // adjusted widths for better centering and responsiveness
      >
        <TiltCard
