...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-8xl sm:text-6xl md:text-9xl lg:text-[8rem] xl:text-[9rem] 2xl:text-[12rem] font-extrabold leading-[0.85] tracking-[0.02em] flex flex-col items-center mx-auto">
